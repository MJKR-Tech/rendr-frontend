      ...
      <div className='function-container'>
          ...
          <div className='subContentR'>
            ...
            <div>
              ...
              <p>
                For dynamic row content, the root data cell must contain the flag "<code>!!> </code>" before the name of the json field.
              </p>
              <ul>
                <li>As shown in the diagram, each data cell with "<code>!!> </code>" will be mapped to one data field in the json data file.</li>
              </ul>
          ...
          <div className='subContentL'>
            <div>
              ...
              <p>
                For dynamic column content, the root data cell must contain the flag "<code>!!v </code>" before the name of the json field.
              </p>
              <ul>
